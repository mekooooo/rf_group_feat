 ...
 */
  /*try:*/ {
    ...
    /* "sklearn/linear_model/sag_fast.pyx":578
 ...
 */
      ...
      /* "sklearn/linear_model/sag_fast.pyx":583
 *         f_idx = feature_ind * n_classes
 * 
 *         cum_sum = cumulative_sums[sample_itr - 1]             # <<<<<<<<<<<<<<
 *         if prox:
 ...
 */
      ...
      /* "sklearn/linear_model/sag_fast.pyx":600
 *                             raise_infinite_error(n_iter)
 *         else:
 *             for class_ind in range(n_classes):             # <<<<<<<<<<<<<<
 *                 idx = f_idx + class_ind
...
/* "sklearn/linear_model/sag_fast.pyx":645
 * 
 * 
 ...
 */
    ...
    /* "sklearn/linear_model/sag_fast.pyx":688
 *                           x_data_ptr[j])
 * 
